...
urlpatterns = patterns(
    ...
    url(
        r'^presence/$',
        views.PresenceList.as_view(),
        name='presence_list'
    ),
    url(
        r'^presence/(?P<status>\d+)/$',
        views.PresenceList.as_view(),
        name='presence_list'
    ),
    url(
        r'presence/add/$',
        views.PresenceAdd.as_view(),
        name='presence_add'
    ),
    url(
        r'presence/update/(?P<pk>\d+)/$',
        views.PresenceUpdate.as_view(),
        name='presence_update'
    ),
    url(
        r'presence/delete/(?P<pk>\d+)/$',
        views.PresenceDelete.as_view(),
